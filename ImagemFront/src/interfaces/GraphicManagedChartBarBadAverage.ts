...
export async function popularGrafico4(data_ini: any, data_fin: any, cidade: any) {
    try {
        const response = await axios.get('http://127.0.0.1:5000/graficos/hoteis/mal-avaliados?data_inicio='+data_ini+'&data_fim='+data_fin+'&cidade='+cidade);
...
export default {chartData, popularGrafico4, chartOptions};