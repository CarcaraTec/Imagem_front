            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    <div>
                        ...
                        <InputText id="login1" type="text" placeholder="Login" class="w-full md:w-30rem mb-5" style="padding: 1rem" v-model="email" />
                        ...
                        <Button @click="handleLogin(email, password)" label="Sign In" class="w-full p-3 text-xl mb-3"></Button>
